...
Au moment de ce rapport, \textbf{788 tests} couvrent notamment les contrats de
...
\begin{figure}[p]
  ...
  \caption{Suivi des expériences dans MLflow. Dagster décrit l'exécution des
  actifs ; MLflow conserve le contexte et les résultats d'expérience.}
  \label{fig:mlflow-final}
\end{figure}
...
le notebook devient une fenêtre de lecture. Un notebook exploratoire sur un
historique marocain profond non ajusté reste archivé et explicitement hors
release tant que cette donnée n'est pas rapprochée et contractualisée.
