...
\begin{figure}[htbp]
  ...
  \caption[Sharpe des stratégies retenues]{Sur le segment de test gelé, les deux
  challengers honnêtement sélectionnés se situent \emph{sous} la stratégie à
  régimes, elle-même sous le comparateur classique.}
  \label{fig:g2004sharpes}
\end{figure}

C'est un énoncé plus fort que le verdict de famille~: celui-ci dit que le
meilleur de 240 n'est pas crédible, tandis que celui-là constate que les
configurations réellement déployables ont fait moins bien.
