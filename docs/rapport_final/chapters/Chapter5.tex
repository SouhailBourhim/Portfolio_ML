...
\textbf{Elle établit} qu'aucun repli n'a été emprunté sur l'instantané publié,
pour les stratégies et les dates comptées ci-dessus. La valeur est une
\emph{mesure reproductible et versionnée}, non une hypothèse — c'est là
l'apport, davantage que le zéro lui-même.

\textbf{Elle n'établit pas} qu'aucun modèle ne replie jamais. Les chemins de
repli sont du code vivant et testé, et un autre instantané peut les emprunter.
L'instrumentation existe précisément pour rendre cette question
\emph{vérifiable}, pas pour trancher d'avance.

\textbf{Le contrôle qui rend le résultat crédible} n'est pas le zéro mais le
