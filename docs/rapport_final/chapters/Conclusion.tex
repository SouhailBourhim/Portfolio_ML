...
% =============================================================================
\section*{Trois résultats à ne pas confondre}
% =============================================================================

L'expérience \texttt{global\_2004} (chapitre~\ref{chap:global2004}) permet de
séparer trois choses que le mot « résultat » confond habituellement, et qu'un
lecteur pressé traduirait à tort par « l'apprentissage automatique a échoué ».

\begin{itemize}
  \item \textbf{Une réussite d'ingénierie.} Un univers a été pré-enregistré et
        horodaté avant toute donnée, contrôlé par dix critères de préparation,
        raccordé à DVC et à Dagster, puis \emph{gelé} comme preuve à usage
        unique. Les artefacts se reconstituent, se vérifient et se réfutent.
  \item \textbf{Une réussite méthodologique.} La correction pour tests
        multiples a fait exactement ce pour quoi elle existe~: un écart
        sélectionné de $+0{,}093$ de Sharpe — plus grand, en valeur absolue,
        que celui de Q1 et de sens opposé — a été empêché de devenir un titre.
        C'est la contribution la plus transportable du projet.
  \item \textbf{L'absence d'avantage établi.} Ni la couche de régimes (Q1) ni
        la famille des challengers (Q2) n'ont établi de supériorité sur des
        règles de portefeuille plus simples, sur cet univers.
\end{itemize}

\begin{remarquebox}
Le message n'est pas que « l'apprentissage automatique échoue ». Il est
qu'\emph{une fois les deux défauts d'identification levés, les modèles complexes
ont enfin reçu un test équitable — et n'ont toujours pas établi d'avantage}. La
contribution du projet est la preuve auditable montrant pourquoi le gagnant brut,
