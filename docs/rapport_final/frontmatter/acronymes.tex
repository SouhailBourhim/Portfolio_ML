...
PSI & \emph{Population Stability Index} — indice de stabilité d'une
distribution entre une référence et une période évaluée \\
RC & \emph{Reality Check} — test de White corrigeant la sélection du meilleur
...
SPA & \emph{Superior Predictive Ability} — test de Hansen pour la comparaison
d'un ensemble de modèles à une référence \\
