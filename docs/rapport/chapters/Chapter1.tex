...
reproductible}, utilisable par un gestionnaire de portefeuille~: collecte et
validation des données, modèles d'allocation, évaluation rigoureuse, et deux
surfaces d'usage (une application web et une interface de programmation).
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}p{6.3cm}p{6.7cm}@{}}
    ...
    Tableau de bord décideur et outil gestionnaire, interface REST &
...
\begin{itemize}
  \item Le projet a été réalisé chez \textbf{EURAFRIC Information}, entreprise de
