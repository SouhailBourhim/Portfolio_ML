...
\paragraph{Observé, non démontré.} Le système complet présente un écart observé
de \textbf{6,2~\%} de ratio de Sharpe net sur le portefeuille visé, et de
$-1{,}6$~\% sur l'univers ETF. Le classement change selon le protocole
d'évaluation retenu et l'écart provient d'une réduction de volatilité, non d'un
