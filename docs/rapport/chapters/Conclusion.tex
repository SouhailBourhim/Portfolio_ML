...
supplément de rendement. Les intervalles de confiance publiés sont marginaux~:
ils quantifient l'incertitude, mais sans bootstrap pairé ils ne permettent ni de
démontrer une supériorité ni de conclure à l'équivalence. Cette réserve est
affichée dans le rapport, le tableau de bord et l'interface de programmation.
