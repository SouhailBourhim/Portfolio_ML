...
Un dernier élément sépare l'exercice académique de l'outil utilisable : un gérant
...
\paragraph{Markowitz (1952), \emph{Portfolio Selection}.} Le texte fondateur, qui
...
\paragraph{DeMiguel, Garlappi et Uppal (2009), \emph{Optimal Versus Naive
Diversification}.} Résultat célèbre et dérangeant : sur de nombreux jeux de
...
validation croisée \emph{purgée} — qui retire du jeu d'entraînement les
observations temporellement voisines du jeu de test — et le \emph{Deflated Sharpe
Ratio} de Bailey et López de Prado (2014), qui corrige un ratio de Sharpe observé
