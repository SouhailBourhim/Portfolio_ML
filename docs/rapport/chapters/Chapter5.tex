...
\begin{figure}[htbp]
  \centering
  \fbox{\includegraphics[width=0.93\textwidth]{assets/figures/dashboard_page1.png}}
...
\begin{figure}[htbp]
  \centering
  \fbox{\includegraphics[width=0.93\textwidth]{assets/figures/dashboard_page2.png}}
  \caption[Tableau de bord — explorateur de stratégies]{Page d'analyse~: comparaison de
