...
Hors échantillon, sur données gelées et avec des barres d'erreur, les écarts
observés entre le système à régimes et les approches classiques restent petits
face à l'incertitude. Les intervalles de confiance sont marginaux et couvrent
environ 1,5 à 2,3 points de Sharpe, pour des écarts de l'ordre de 0,07. Ils ne
permettent ni de démontrer une supériorité, ni de conclure à l'équivalence~: un
bootstrap pairé sur les écarts de rendements serait nécessaire.
\end{resultatbox}
...
\begin{itemize}
  ...
  \item \textbf{Observé, non démontré} — le système à régimes dépasse le Markowitz
        ...
        de $1{,}6$~\% sur l'univers ETF. Les intervalles sont marginaux et le
        classement dépend du protocole d'évaluation et de la mesure retenue ;
        aucun test pairé ne conclut à une supériorité.
