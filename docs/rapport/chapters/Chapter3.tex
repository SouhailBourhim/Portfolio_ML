...
Le dépôt compte \textbf{plus de 580 tests}, exécutés hors ligne
...
\begin{figure}[htbp]
  \centering
  \fbox{\includegraphics[width=0.95\textwidth]{assets/figures/mlflow_ui.png}}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}p{3.3cm}p{9.2cm}@{}}
    ...
    pytest & Plus de 580 tests, hors ligne, exécutés à chaque modification. \\
    \bottomrule
  \end{tabular}
\end{table}
