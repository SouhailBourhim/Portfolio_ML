...
aucun des 1\,188 ajustements de stratégie n'a utilisé de repli d'estimateur~:
chaque résultat provient bien du modèle que son étiquette désigne. Sous validation strictement antérieure, les huit
...
1\,188 strategy fits used an estimator fallback: every result was produced by
the model its label names. Published
